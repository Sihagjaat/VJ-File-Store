...
PICS = (environ.get('PICS', 'https://envs.sh/PV1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5860332990').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Privatefilestorerobot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://amitsihag12562:WSEB9kFCoLujTJAf@cluster0.wlqrs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_URL = environ.get("SHORTLINK_URL", "indianshortner.com") # shortlink domain without https://
SHORTLINK_API = environ.get("SHORTLINK_API", "c9db82e92c5ac629a3690636f1f73240742a6aa5") # shortlink api
